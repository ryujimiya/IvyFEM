...
namespace IvyFEM
{
    ...
    {
        private void CalcABStandardKEpsilon(IvyFEM.Linear.DoubleSparseMatrix A, double[] B)
        {
            uint vQuantityId = 0;
            uint pQuantityId = 1;
            uint kpQuantityId = 2;
                ...
                for (int ipPt = 0; ipPt < ip.PointCount; ipPt++)
                {
                    ...
                    for (int row = 0; row < kpElemNodeCnt; row++)
                    {
                        ...
                        for (int col = 0; col < kpElemNodeCnt; col++)
                        {
                            ...
                            {
                                kkk2 +=
                                    detJWeight * (mut / sigmaK) * kpNu[kDof][row] * kpNu[kDof][col];
                            }
                    ...
                    for (int row = 0; row < epElemNodeCnt; row++)
                    {
                        ...
                        for (int col = 0; col < epElemNodeCnt; col++)
                        {
                            ...
                            {
                                kee2 +=
                                    detJWeight * (mut / sigmaE) * epNu[kDof][row] * epNu[kDof][col];
                            }
