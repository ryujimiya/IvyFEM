...
namespace IvyFEM
{
    public class ElasticWaveguide2DFEM : FEM
    {
        ...
        public ElasticWaveguide1DEigenFEM[] EigenFEMs { get; private set; } 

        public ElasticWaveguide2DFEM(FEWorld world)
        {
            World = world;
        }
        ...
        public override void Solve()
        {
            ...
            ElasticWaveguide1DEigenFEM[] eigenFEMs;
        ...
        private void SetBoundaryCondition(double omega,
            ...
            uint portCnt, out ElasticWaveguide1DEigenFEM[] eigenFEMs)
        {
            int uDof = 2;
            int sDof = 2;
            ...
            eigenFEMs = new ElasticWaveguide1DEigenFEM[portCnt];
            ...
            for (uint portId = 0; portId < portCnt; portId++)
            {
                ...
                var eigenFEM = new ElasticWaveguide1DEigenFEM(World, UQuantityId, portId);
        ...
        private System.Numerics.Complex[][] CalcS(double omega,
            ...
            System.Numerics.Complex[] coordSigma,
            uint portCnt, ElasticWaveguide1DEigenFEM[] eigenFEMs)
        {
            ...
            out System.Numerics.Complex[] coordSigma)
        {
            ...
            var cSigmaYXValues = new Dictionary<int, IList<System.Numerics.Complex>>();
            ...
            foreach (uint feId in feIds)
            {
                ...
                for (int iNode = 0; iNode < elemNodeCnt; iNode++)
                {
                    ...
                    }
                    {
                        ...
                        if (cSigmaYXValues.ContainsKey(coId))
                        {
                            sigmaYXValues = cSigmaYXValues[coId];
                        }
                        else
                        {
                            sigmaYXValues = new List<System.Numerics.Complex>();
                            cSigmaYXValues.Add(coId, sigmaYXValues);
                        }
            ...
            for (int coId = 0; coId < coCnt; coId++)
            {
                IList<System.Numerics.Complex>[] sigmaValues = {
                    ...
                    cSigmaYXValues.ContainsKey(coId) ? cSigmaYXValues[coId] : new List<System.Numerics.Complex>()
                };
