...
namespace IvyFEM
{
    ...
    {
        protected void _InitMITCHyperelasticPlateNodeValues(int coId, FieldValue uFV)
        {
            Elastic3DFEMUtils.InitMITCHyperelasticPlateNodeValues(coId, uFV);
        }

        protected void _InitMITCHyperelasticPlateElementNodeValues(
            uint feId, OpenTK.Vector3d[] xPt0s,
            FieldValue vnFV, FieldValue v1FV, FieldValue v2FV, FieldValue lambdaFV)
        {
            Elastic3DFEMUtils.InitMITCHyperelasticPlateElementNodeValues(
                feId, xPt0s, vnFV, v1FV, v2FV, lambdaFV);
        }

        protected void _UpdateMITCHyperelasticPlateNodeValues(int coId, double[] curNodeUg, FieldValue uFV)
        {
            Elastic3DFEMUtils.UpdateMITCHyperelasticPlateNodeValues(coId, curNodeUg, uFV);
        }

        protected void _UpdateMITCHyperelasticPlateElementNodeValues(
            uint feId, int nodeCnt, double[] curUg,
            FieldValue vnFV, FieldValue v1FV, FieldValue v2FV, FieldValue lambdaFV)
        {
            Elastic3DFEMUtils.UpdateMITCHyperelasticPlateElementNodeValues(
                feId, nodeCnt, curUg, vnFV, v1FV, v2FV, lambdaFV);
        }

        protected void InitMITCMooneyRivlinPlateNodeValues(uint quantityId, int coId)
        {
            if (quantityId != 0)
            {
                return;
            ...
            foreach (uint feId in feIds)
            {
                ...
                if (workMa is MITCMooneyRivlinPlateMaterial)
                {
                    hitTrFE = workTriFE;
                    break;
                }
            ...
            _InitMITCHyperelasticPlateNodeValues(coId, uFV);
        }

        protected void InitMITCMooneyRivlinPlateElementValues(uint feId)
        {
            {
                uint quantityId0 = 0;
            ...
            _InitMITCHyperelasticPlateElementNodeValues(feId, dPts, vnFV, v1FV, v2FV, lambdaFV);
        }

        protected void UpdateMITCMooneyRivlinPlateNodeValues(uint quantityId, int coId)
        {
            if (quantityId != 0)
            {
                return;
            ...
            _UpdateMITCHyperelasticPlateNodeValues(coId, nodeUg, uFV);
        }

        protected void UpdateMITCMooneyRivlinPlateElementValues(uint feId)
        {
            {
                uint quantityId0 = 0;
            ...
            _UpdateMITCHyperelasticPlateElementNodeValues(
                feId, (int)rElemNodeCnt, curUg, vnFV, v1FV, v2FV, lambdaFV);
        }


        protected void CalcMITCMooneyRivlinPateKe(
            double c1, double c2,
        ...
        {
            Elastic3DFEMUtils.CalcMITCMooneyRivlinPateKe(
                c1, c2,
        ...
        protected void CalcMITCMooneyRivlinPlateElementAB(
        ...
        {
            {
                ...
                if (!(workMa0 is MITCMooneyRivlinPlateMaterial))
                {
                    return;
                }
            }
            ...
            System.Diagnostics.Debug.Assert(ma0 is MITCMooneyRivlinPlateMaterial);
            ...
            var ma = ma0 as MITCMooneyRivlinPlateMaterial;
