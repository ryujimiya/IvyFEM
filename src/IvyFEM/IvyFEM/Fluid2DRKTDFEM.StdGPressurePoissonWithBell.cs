...
namespace IvyFEM
{
    ...
    {
        private void CalcStdGPressurePoissonWithBell1stEquationKMF(
        ...
        private void CalcStdGPressurePoissonWithBell2ndEquationAB(IvyFEM.Linear.DoubleSparseMatrix A, double[] B)
        {
            int quantityCnt = World.GetQuantityCount();
            System.Diagnostics.Debug.Assert(quantityCnt == 7);
            uint vQuantityId = 0;
