...
namespace IvyFEM
{
    ...
    {
        protected void CalcTimoshenkoCorotationalFrameKl(
        ...
        {
            Elastic2DFEMUtils.CalcTimoshenkoCorotationalFrameKl(
                E, G, kappa, Ae, Iz,
                l0, barU, barT1, barT2,
                out fl, out kl);
        }
        ...
        {
            {
                ...
                if (!(workMa0 is TimoshenkoCorotationalFrameMaterial))
                {
                    return;
                }
            }
            ...
            System.Diagnostics.Debug.Assert(ma0 is TimoshenkoCorotationalFrameMaterial);
            ...
            CalcTimoshenkoCorotationalFrameKl(E, G, kappa, Ae, Iz, l0, barU, barT1, barT2, out fl, out kl);
