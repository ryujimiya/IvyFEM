...
namespace IvyFEM
{
    ...
    {
        private void CalcStdGPressurePoisson1stEquationKMF(
                ...
                for (int ipPt = 0; ipPt < ip.PointCount; ipPt++)
                {
                    ...
                    for (int row = 0; row < vElemNodeCnt; row++)
                    {
                        ...
                        for (int col = 0; col < pElemNodeCnt; col++)
                        {
                            ...
                            for (int rowDof = 0; rowDof < vDof; rowDof++)
                            {
                                double pValue = U[offset + colNodeId];
        ...
        private void CalcStdGPressurePoisson2ndEquationAB(IvyFEM.Linear.DoubleSparseMatrix A, double[] B)
        {
            uint vQuantityId = 0;
            uint pQuantityId = 1;
            int vDof = 2;
