...
namespace IvyFEM
{
    partial class Elastic3DEigenFEM
    {
        ...
        protected void CalcMITCLinearPlateElementKM(
                ...
                for (int col = 0; col < dElemNodeCnt; col++)
                {
                    ...
                    for (int rowDof = 0; rowDof < dDof; rowDof++)
                    {
                        for (int colDof = 0; colDof < dDof; colDof++)
                        {
                            ...
                            K[rowNodeId * dDof + rowDof, colNodeId * dDof + colDof] += kValue;
                            M[rowNodeId * dDof + rowDof, colNodeId * dDof + colDof] += mValue;
                        }
                    }
                }
                // rotation
                for (int col = 0; col < rElemNodeCnt; col++)
                {
                    ...
                    for (int rowDof = 0; rowDof < dDof; rowDof++)
                    {
                        for (int colDof = 0; colDof < rDof; colDof++)
                        {
                            ...
                            K[rowNodeId * dDof + rowDof, colNodeId * rDof + colDof + rOffset] += kValue;
                            M[rowNodeId * dDof + rowDof, colNodeId * rDof + colDof + rOffset] += mValue;
                        }
                    }
                }
            }
                ...
                for (int col = 0; col < dElemNodeCnt; col++)
                {
                    ...
                    for (int rowDof = 0; rowDof < rDof; rowDof++)
                    {
                        for (int colDof = 0; colDof < dDof; colDof++)
                        {
                            ...
                            K[rowNodeId * rDof + rowDof + rOffset, colNodeId * dDof + colDof] += kValue;
                            M[rowNodeId * rDof + rowDof + rOffset, colNodeId * dDof + colDof] += mValue;
                        }
                    }
                }
                // rotation
                for (int col = 0; col < rElemNodeCnt; col++)
                {
                    ...
                    for (int rowDof = 0; rowDof < rDof; rowDof++)
                    {
                        for (int colDof = 0; colDof < rDof; colDof++)
                        {
                            ...
                            K[rowNodeId * rDof + rowDof + rOffset, colNodeId * rDof + colDof + rOffset] += kValue;
                            M[rowNodeId * rDof + rowDof + rOffset, colNodeId * rDof + colDof + rOffset] += mValue;
                        }
                    }
                }
            }
